...
和 java 中线程的 interrupt() 方法一样，kill 也只是给线程设置一个终止标志。
...
![image-20210907162059185](图片/image-20210907162059185.png)
...
![image-20210907162147457](图片/image-20210907162147457.png)
...
如果你发现一个线程处于Killed状态，你可以做的事情就是，通过影响系统环境，让这个Killed状态尽快结束。
...
![image-20210907162823727](图片/image-20210907162823727.png)
